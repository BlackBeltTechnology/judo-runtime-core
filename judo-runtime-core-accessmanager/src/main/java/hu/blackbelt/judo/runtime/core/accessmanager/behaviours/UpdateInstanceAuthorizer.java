...
@Builder
public class UpdateInstanceAuthorizer extends BehaviourAuthorizer {
    ...
    public boolean isSuitableForOperation(final EOperation operation) {
        return AsmUtils.getBehaviour(operation).filter(o -> o == AsmUtils.OperationBehaviour.UPDATE_INSTANCE || o == AsmUtils.OperationBehaviour.VALIDATE_UPDATE).isPresent();
    }
