...
public class AccessTokenVariableProviderProvider implements Provider<Function<String, Object>> {

    Context context;

    @Inject
    public AccessTokenVariableProviderProvider(Context context) {
        this.context = context;
    }

    @Override
    public Function<String, Object> get() {
        return new AccessTokenVariableProvider(context);
    }
}
