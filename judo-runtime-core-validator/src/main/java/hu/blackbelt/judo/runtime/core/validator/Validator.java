...
public interface Validator {
    ...
    String ERROR_MISSING_REQUIRED_ATTRIBUTE_ON_ENTITY = "MISSING_REQUIRED_ATTRIBUTE_ON_ENTITY";
    String ERROR_MISSING_REQUIRED_RELATION = "MISSING_REQUIRED_RELATION";
    String ERROR_MISSING_REQUIRED_RELATION_ON_ENTITY = "MISSING_REQUIRED_RELATION_ON_ENTITY";
