...
public class RdbmsColumn extends RdbmsField {
    ...
    public String toSql(SqlConverterContext converterContext) {
        ...
        final String sql = cast(MessageFormat.format(pattern != null ? pattern : DEFAULT_PATTERN,
                        partnerTableName,
                        columnName),
                null,
                targetAttribute);
