...
import static hu.blackbelt.judo.services.dao.rdbms.query.utils.RdbmsAliasUtil.getTargetColumnAlias;
...
public abstract class RdbmsField {
    ...
    public String getRdbmsAlias() {
        return (target != null ? getTargetColumnAlias(target, alias) : alias);
    }
