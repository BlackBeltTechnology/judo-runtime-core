...
public class SubjectBoundRelationMC2MC implements SubjectCollectionCreator {
    private final PsmTestModelBuilder modelBuilder;

    public SubjectBoundRelationMC2MC() {
        modelBuilder = new PsmTestModelBuilder();
        modelBuilder.addEntity("Entity2");
        modelBuilder.addEntity("Entity")
                .withRelation("Entity2", "te", cardinality(0, -1));
    ...
    public String getName() {
        return "SubjectBoundRelationMC2MC";
    }
