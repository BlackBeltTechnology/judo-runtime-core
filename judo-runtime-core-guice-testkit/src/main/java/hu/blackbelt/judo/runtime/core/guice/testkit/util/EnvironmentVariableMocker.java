...
public class EnvironmentVariableMocker {
    ...
    public static void deinitMocked() {
        synchronized (sync) {
            if (mocked != null) {
                mocked.close();
                mocked = null;
