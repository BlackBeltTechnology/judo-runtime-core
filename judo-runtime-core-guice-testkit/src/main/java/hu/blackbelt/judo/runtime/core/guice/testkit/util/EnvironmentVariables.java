...
public class EnvironmentVariables
    ...
    public EnvironmentVariables(String name, String value, String... others) {
        if (others.length % 2 != 0) {
            throw new IllegalArgumentException(
                "Must provide even number of parameters"
            );
        }
    ...
    /**
     * <em>Mutable remover:</em> removes the environment variable from the stored environment variables
     * and removes it from the environment too if currently active.
