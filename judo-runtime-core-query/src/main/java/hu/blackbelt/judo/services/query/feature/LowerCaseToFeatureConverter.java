...
public class LowerCaseToFeatureConverter extends ExpressionToFeatureConverter<LowerCase> {

    public LowerCaseToFeatureConverter(FeatureFactory factory, AsmModelAdapter modelAdapter) {
        super(factory, modelAdapter);
    }

    @Override
    public Feature convert(final LowerCase expression, final Context context, final FeatureTargetMapping targetMapping) {
        final Feature feature = newFunctionBuilder()
                .withSignature(FunctionSignature.LOWER_STRING)
