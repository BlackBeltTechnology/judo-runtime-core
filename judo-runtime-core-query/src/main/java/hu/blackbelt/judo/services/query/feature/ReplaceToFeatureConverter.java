...
public class ReplaceToFeatureConverter extends ExpressionToFeatureConverter<Replace> {

    public ReplaceToFeatureConverter(FeatureFactory factory, AsmModelAdapter modelAdapter) {
        super(factory, modelAdapter);
    }

    @Override
    public Feature convert(final Replace expression, final Context context, final FeatureTargetMapping targetMapping) {
        final Feature feature = newFunctionBuilder()
                .withSignature(FunctionSignature.REPLACE_STRING)
                ...
                .withParameters(newFunctionParameterBuilder()
                        ...
                        .withParameterValue(factory.convert(expression.getReplacement(), context, null))
                        .build())
