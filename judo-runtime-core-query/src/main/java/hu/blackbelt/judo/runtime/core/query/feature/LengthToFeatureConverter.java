...
public class LengthToFeatureConverter extends ExpressionToFeatureConverter<Length> {

    public LengthToFeatureConverter(FeatureFactory factory, AsmModelAdapter modelAdapter) {
        super(factory, modelAdapter);
    }

    @Override
    public Feature convert(final Length expression, final Context context, final FeatureTargetMapping targetMapping) {
