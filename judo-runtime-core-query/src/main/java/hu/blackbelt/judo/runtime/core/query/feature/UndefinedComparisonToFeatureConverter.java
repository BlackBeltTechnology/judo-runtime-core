...
public class UndefinedComparisonToFeatureConverter extends ExpressionToFeatureConverter<UndefinedComparison> {

    public UndefinedComparisonToFeatureConverter(FeatureFactory factory, AsmModelAdapter modelAdapter) {
        super(factory, modelAdapter);
    }

    @Override
    public Feature convert(final UndefinedComparison expression, final Context context, final FeatureTargetMapping targetMapping) {
        final Feature feature = newFunctionBuilder()
                .withSignature(FunctionSignature.IS_UNDEFINED)
