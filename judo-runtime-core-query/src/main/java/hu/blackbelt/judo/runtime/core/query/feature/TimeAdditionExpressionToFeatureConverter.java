...
public class TimeAdditionExpressionToFeatureConverter extends ExpressionToFeatureConverter<TimeAdditionExpression> {

    public TimeAdditionExpressionToFeatureConverter(FeatureFactory factory, AsmModelAdapter modelAdapter) {
        super(factory, modelAdapter);
    }

    @Override
    public Feature convert(final TimeAdditionExpression expression, final Context context, final FeatureTargetMapping targetMapping) {
        ...
        final Feature feature = newFunctionBuilder()
                .withSignature(FunctionSignature.ADD_TIME)
                .withParameters(newFunctionParameterBuilder()
