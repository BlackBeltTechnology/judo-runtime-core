...
@Slf4j
public class GetInputRangeCall<ID> extends AlwaysRollbackTransactionalBehaviourCall {
    ...
    @SneakyThrows
    public GetInputRangeCall(Context context, DAO dao, IdentifierProvider<ID> identifierProvider, AsmUtils asmUtils, ExpressionModel expressionModel, TransactionManager transactionManager, Coercer coercer, boolean caseInsensitiveLike) {
