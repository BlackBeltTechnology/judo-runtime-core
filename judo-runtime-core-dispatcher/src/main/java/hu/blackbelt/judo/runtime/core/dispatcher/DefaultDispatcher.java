	...
	private void setupBehaviourCalls(DAO<ID> dao, IdentifierProvider<ID> identifierProvider, AsmUtils asmUtils) {
        behaviourCalls = ImmutableSet.<BehaviourCall<ID>>builder()
                .add(
                        ...
                        new CreateInstanceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager),
                        ...
                        new UpdateInstanceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager, dataTypeManager.getCoercer()),
                        new ValidateUpdateCall<>(dao, identifierProvider, asmUtils, transactionManager, dataTypeManager.getCoercer()),
                        new DeleteInstanceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager),
                        new SetReferenceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager),
                        new UnsetReferenceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager),
                        new AddReferenceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager),
                        new RemoveReferenceCallAlwaysCommit<>(dao, identifierProvider, asmUtils, transactionManager),
