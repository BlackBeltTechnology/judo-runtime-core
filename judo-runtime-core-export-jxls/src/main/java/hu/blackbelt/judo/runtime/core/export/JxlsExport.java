...
public class JxlsExport implements Export {
    ...
    @Override
    public void exportToOutputStream(OutputStream output, String type, List<Payload> list, List<String> attributes, Class clazz, Locale locale) {
    ...
    @Override
    public InputStream exportToInputStream(String type, List<Payload> list, List<String> attributes, OutputStream output, Class clazz, Locale locale) {
        throw new UnsupportedOperationException("Not implemented");
    }
