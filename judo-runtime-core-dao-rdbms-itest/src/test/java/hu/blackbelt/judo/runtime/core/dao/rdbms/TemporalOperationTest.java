...
public class TemporalOperationTest {
    ...
    @Test
    void testOperations(RdbmsDaoFixture testFixture, RdbmsDatasourceFixture datasourceFixture) {
        ...
        // assertEquals(timestamp.atZoneSameInstant(OffsetDateTime.now().getOffset()).getHour(),
